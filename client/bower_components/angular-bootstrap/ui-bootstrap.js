  ...
  .controller("UibDatepickerController", [
    ...
    function (
      ...
      this.init = function (ngModelCtrl_) {
        ...
        ngModelOptions =
          ngModelCtrl_.$options || datepickerConfig.ngModelOptions;
      ...
      $scope.isDisabled = function (date) {
        ...
        angular.forEach(["minDate", "maxDate"], function (key) {
          if (!$scope.datepickerOptions[key]) {
            ...
            dates[key] = dateParser.fromTimezone(
              new Date($scope.datepickerOptions[key]),
              timezone
            );
          } else {
...
angular
  .module("ui.bootstrap.pager", ["ui.bootstrap.paging"])
...
angular
  .module("ui.bootstrap.pagination", ["ui.bootstrap.paging"])
                  ...
                  if (!positionTimeout) {
                    positionTimeout = $timeout(
                      function () {
                        ...
                        if (
                          !tooltip.hasClass(ttPosition.placement.split("-")[0])
                        ) {
