...
angular
  ...
  .controller("AccordionController", [
    ...
    function ($scope, $attrs, $controller, $log, $accordionSuppressWarning) {
  ...
  .directive("accordion", [
    "$log",
    "$accordionSuppressWarning",
    function ($log, $accordionSuppressWarning) {
      return {
        restrict: "EA",
        controller: "AccordionController",
        controllerAs: "accordion",
...
angular
  ...
  .controller("AlertController", [
    ...
    function ($scope, $attrs, $controller, $log, $alertSuppressWarning) {
  ...
  .directive("alert", [
    "$log",
    "$alertSuppressWarning",
    function ($log, $alertSuppressWarning) {
      return {
        controller: "AlertController",
        controllerAs: "alert",
        templateUrl: function (element, attrs) {
...
angular
  ...
  .directive("btnCheckbox", [
    ...
    "$log",
    "$buttonsSuppressWarning",
    function ($document, $log, $buttonsSuppressWarning) {
      return {
...
angular
  ...
  .controller("CarouselController", [
    ...
    function ($scope, $element, $controller, $log, $carouselSuppressWarning) {
  ...
  .directive("carousel", [
    "$log",
    "$carouselSuppressWarning",
    function ($log, $carouselSuppressWarning) {
      return {
        transclude: true,
        replace: true,
        controller: "CarouselController",
...
angular
  ...
  .service("dateParser", [
    ...
    "uibDateParser",
    function ($log, $dateParserSuppressWarning, uibDateParser) {
...
angular
  ...
  .service("$position", [
    ...
    "$uibPosition",
    function ($log, $positionSuppressWarning, $uibPosition) {
...
angular
  ...
  .directive("datepicker", [
    "$log",
    "$datepickerSuppressWarning",
    function ($log, $datepickerSuppressWarning) {
      return {
        replace: true,
        templateUrl: function (element, attrs) {
          return attrs.templateUrl || "template/datepicker/datepicker.html";
  ...
  .controller("UibDropdownController", [
    ...
    function (
      ...
      scope.$watch("isOpen", function (isOpen, wasOpen) {
        ...
        $animate[isOpen ? "addClass" : "removeClass"]($element, openClass).then(
          function () {
...
angular
  ...
  .directive("dropdown", [
    "$log",
    "$dropdownSuppressWarning",
    function ($log, $dropdownSuppressWarning) {
      return {
        controller: "DropdownController",
        link: function (scope, element, attrs, dropdownCtrl) {
          if (!$dropdownSuppressWarning) {
...
angular
  ...
  .directive("pagination", [
    ...
    "$log",
    "$paginationSuppressWarning",
    function ($parse, paginationConfig, $log, $paginationSuppressWarning) {
      return {
        restrict: "EA",
        scope: {
          totalItems: "=",
...
angular
  ...
  .provider("$tooltip", [
    ...
    function ($uibTooltipProvider) {
      ...
      this.$get = [
        ...
        "$injector",
        function ($log, $tooltipSuppressWarning, $injector) {
  ...
  .directive("tooltipClasses", [
    "$log",
    "$tooltipSuppressWarning",
    function ($log, $tooltipSuppressWarning) {
      return {
        restrict: "A",
        link: function (scope, element, attrs) {
          if (!$tooltipSuppressWarning) {
...
angular
  ...
  .directive("popoverTemplatePopup", [
    ...
    function ($log, $popoverSuppressWarning) {
      return {
        replace: true,
        scope: {
          title: "@",
...
angular
  ...
  .controller("ProgressController", [
    ...
    function ($scope, $attrs, progressConfig, $log, $progressSuppressWarning) {
...
angular
  ...
  .controller("RatingController", [
    ...
    function ($scope, $attrs, $controller, $log, $ratingSuppressWarning) {
  ...
  .directive("rating", [
    "$log",
    "$ratingSuppressWarning",
    function ($log, $ratingSuppressWarning) {
      return {
...
angular
  ...
  .directive("timepicker", [
    "$log",
    "$timepickerSuppressWarning",
    function ($log, $timepickerSuppressWarning) {
      return {
        restrict: "EA",
    ...
    function (
      ...
      element.bind("keydown", function (evt) {
        ...
        if (evt.which === 40) {
          ...
          scope.activeIdx =
            (scope.activeIdx > 0 ? scope.activeIdx : scope.matches.length) - 1;
          scope.$digest();
      ...
      if (appendToBody) {
        ...
        angular
          .element($document[0].getElementById(appendToElementId))
          .append($popup);
      } else {
        element.after($popup);
      }
...
angular
  ...
  .service("typeaheadParser", [
    ...
    function ($parse, uibTypeaheadParser, $log, $typeaheadSuppressWarning) {
