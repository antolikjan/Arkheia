...
(function (y) {
  ...
  function q(a, b, d) {
    ...
    if (a)
      ...
      else if (xc(a)) for (c in a) b.call(d, a[c], c, a);
  ...
  function sa(a, b) {
    function d(a, b) {
      ...
      } else if (xc(a)) for (e in a) b[e] = c(a[e]);
  ...
  function na(a, b) {
    ...
    if (d === typeof b && "object" === d)
      if (I(a)) {
        ...
        if (ja(a)) return ja(b) ? na(a.getTime(), b.getTime()) : !1;
  ...
  function se(a, b) {
    ...
    d &&
      (te
        ? ((f.strictDi = null !== re(d, "strict-di")), b(d, c ? [c] : [], f))
        : y.console.error(
  ...
  function Gc(a, b, d) {
    ...
    y &&
      f.test(y.name) &&
      ((d.debugInfoEnabled = !0), (y.name = y.name.replace(f, "")));
  ...
  function xe() {
    ...
    if (!Ic) {
      var b = ub();
      (za = z(b) ? y.jQuery : b ? y[b] : void 0) && za.fn.on
        ? ((F = za),
          R(za.fn, {
            scope: Pa.scope,
          ...
          (a = za.cleanData),
          (za.cleanData = function (b) {
            for (var c, f = 0, e; null != (e = b[f]); f++)
              (c = za._data(e, "events")) &&
                c.$destroy &&
                za(e).triggerHandler("$destroy");
            a(b);
          }))
        : (F = W);
      $.element = F;
    ...
    if (e)
      if (b) {
        var g = function (b) {
          ...
          x(d) && bb(c || [], d);
          (x(d) && c && 0 < c.length) ||
            (a.removeEventListener(b, e, !1), delete f[b]);
        };
        ...
        for (b in f)
          "$destroy" !== b && a.removeEventListener(b, e, !1), delete f[b];
  }
  function ib(a, b) {
    var d = a.ng339,
      c = d && jb[d];
    c &&
      (b
        ? delete c.data[b]
        : (c.handle && (c.events.$destroy && c.handle({}, "$destroy"), Wc(a)),
          delete jb[d],
          (a.ng339 = void 0)));
  }
  function zb(a, b) {
    ...
    b &&
      !d &&
      ((a.ng339 = d = ++bg),
      (d = jb[d] = { events: {}, data: {}, handle: void 0 }));
    return d;
  }
  function $b(a, b, d) {
    if (Sc(a)) {
        ...
        !c.history || (h && f)
          ? (h || (N = b),
            d
              ...
              : (l.href = b),
            l.href !== b && (N = b))
          : (m[d ? "replaceState" : "pushState"](e, "", b), g(), (K = p));
        N && (N = b);
        return k;
      }
      ...
      function (a, b, c, f, n, M, J, B, T, S) {
        ...
        function Ma(a, b, c, d, e, f) {
          function g(a, c, d, e) {
            ...
            for (n = h.length; m < n; )
              (k = A[h[m++]]),
                ...
                c
                  ? (c.scope
                      ? ((l = a.$new()), ca.$$addScopeInfo(F(k), l))
                      : (l = a),
                    (s = c.transcludeOnThisElement
                      ? G(a, c.transclude, e)
          ...
          for (var h = [], k, l, m, n, p, s = 0; s < a.length; s++) {
            ...
            (f = l.length ? W(l, a[s], k, b, c, null, [], [], f) : null) &&
              f.scope &&
              ca.$$addScopeClass(k.$$element);
            k =
              (f && f.terminal) || !(m = a[s].childNodes) || !m.length
                ? null
                : Ma(
                    m,
                    f
        ...
        function cc(a, b, c, d, e) {
          ...
          switch (a.nodeType) {
            case 1:
              ...
              U(b, Da(g), "E", d, e);
              for (
                var k, l, m, n, p = a.attributes, s = 0, A = p && p.length;
                s < A;
                s++
              ) {
                var r = !1,
        ...
        function W(a, b, d, e, f, g, h, k, l) {
          function m(a, b, c, d) {
            if (a) {
              ...
              a.require = v.require;
              a.directiveName = S;
              if (u === v || v.$$isolateScope) a = ra(a, { isolateScope: !0 });
              h.push(a);
            }
            if (b) {
              c && (b = dd(b, c, d));
              b.require = v.require;
              b.directiveName = S;
              if (u === v || v.$$isolateScope) b = ra(b, { isolateScope: !0 });
              k.push(b);
            }
          }
          function n(a, e, f, g, l) {
            ...
            u &&
              (ca.$$addScopeInfo(
                ...
                M,
                !0,
                !(O && (O === u || O === u.$$originalDirective))
              ),
              ca.$$addScopeClass(P, !0),
              (M.$$isolateBindings = u.$$isolateBindings),
              (v = la(e, g, M, M.$$isolateBindings, u)),
              v.removeWatches && M.$on("$destroy", v.removeWatches));
            for (p in J) {
              v = r[p];
              B = J[p];
              ...
              if (s) {
                ...
                ac !== B.instance &&
                  ((B.instance = ac),
                  P.data("$" + v.name + "Controller", ac),
                  B.bindingInfo.removeWatches && B.bindingInfo.removeWatches(),
                  (B.bindingInfo = la(T, g, B.instance, L, v)));
              } else
                (B.instance = B()),
                  P.data("$" + v.name + "Controller", B.instance),
                  (B.bindingInfo = la(T, g, B.instance, L, v));
            }
            q(r, function (a, b) {
              var c = a.require;
            ...
            for (v = h.length; p < v; p++)
              (B = h[p]),
                sa(
                  ...
                  P,
                  g,
                  B.require && X(B.directiveName, B.require, P, J),
                  S
                );
            var qa = e;
          ...
          for (
            var p = -Number.MAX_VALUE,
              A = l.newScopeDirective,
              r = l.controllerDirectives,
              u = l.newIsolateScopeDirective,
              O = l.templateDirective,
              M = l.nonTlbTranscludeDirective,
              T = !1,
              J = !1,
              H = l.hasElementTranscludeDirective,
              B = (d.$$element = F(b)),
              v,
              S,
              P,
            ...
            if ((w = v.scope))
              v.templateUrl ||
                (E(w)
                  ? ($("new/isolated scope", u || A, v, B), (u = v))
                  : $("new/isolated scope", u, v, B)),
                (A = A || v);
            S = v.name;
            if (
              !x &&
            ...
            !v.templateUrl &&
              v.controller &&
              ((r = r || V()),
              $("'" + S + "' controller", r[S], v, B),
              (r[S] = v));
            if ((w = v.transclude))
              if (
                ((T = !0),
                v.$$tlb || ($("transclusion", M, v, B), (M = v)),
                "element" === w)
              )
                (H = !0),
                  (p = v.priority),
                  (P = B),
                  (B = d.$$element = F(ca.$$createComment(S, d[S]))),
                  (b = B[0]),
                  ga(f, va.call(P, 0), b),
                  (P[0].$$parentNode = P[0].parentNode),
                  (L = dc(Ja, P, e, p, g && g.name, {
            ...
            if (v.template)
              if (
                ...
                $("template", O, v, B),
                (O = v),
                (w = C(v.template) ? v.template(B, d) : v.template),
                (w = Ca(w)),
                v.replace)
              ) {
                g = v;
            ...
            if (v.templateUrl)
              ...
              try {
                ...
                C(qa)
                  ? m(null, db(Z, qa), Ta, Ma)
                  : qa && m(db(Z, qa.pre), db(Z, qa.post), Ta, Ma);
              } catch (da) {
                c(da, ya(B));
              }
        ...
        function U(b, c, f, g, h, k, l) {
          ...
          if (e.hasOwnProperty(c)) {
            ...
            for (var n = 0, p = h.length; n < p; n++)
              if (
                ((c = h[n]),
                (z(g) || g > c.priority) && -1 !== c.restrict.indexOf(f))
              ) {
                k && (c = Tb(c, { $$start: k, $$end: l }));
                if (!c.$$bindings) {
                  var s = (m = c),
                    r = c.name,
                    v = { isolateScope: null, bindToController: null };
                  E(s.scope) &&
                    (!0 === s.bindToController
                      ? ((v.bindToController = d(s.scope, r, !0)),
                        (v.isolateScope = {}))
                      : (v.isolateScope = d(s.scope, r, !1)));
                  E(s.bindToController) &&
                    (v.bindToController = d(s.bindToController, r, !0));
        ...
        function ia(a, b, c, d, e, g, h, k) {
          ...
          f(r).then(function (f) {
            ...
            for (n = Ma(b[0].childNodes, e); l.length; ) {
              ...
              if (!f.$$destroyed) {
                if (B !== p) {
                  var J = B.className;
                  (k.hasElementTranscludeDirective && s.replace) || (O = Zb(u));
                  ga(M, F(B), O);
                  Ja(F(O), J);
                }
          ...
          return function (a, b, c, d, e) {
            ...
            b.$$destroyed ||
              (l
                ? l.push(b, c, d, a)
                : (m.transcludeOnThisElement && (a = G(b, m.transclude, e)),
                  m(n, b, c, d, a)));
          };
        }
        function ja(a, b) {
        ...
        t.prototype = {
          ...
          $set: function (a, b, d, e) {
            ...
            e
              ? (this.$attr[a] = e)
              : (e = this.$attr[a]) || (this.$attr[a] = e = Hc(a, "-"));
            f = wa(this.$$element);
            if (
        ...
        return function (e, g, h, k) {
          ...
          if (D(e)) {
            ...
            e = a.hasOwnProperty(m)
              ? a[m]
              : Jc(g.$scope, m, !0) || (b ? Jc(c, m, !0) : void 0);
            if (!e) throw id("ctrlreg", m);
            Qa(e, m, !0);
          }
          if (h)
            return (
              (h = (I(e) ? e[e.length - 1] : e).prototype),
    ...
    this.$get = [
      ...
      function (f, e, g, h, k, l) {
        function m(b) {
          ...
          g.paramSerializer = D(g.paramSerializer)
        ...
        function n(c, d) {
          ...
          function l(a, c, d, e) {
            ...
            J &&
              (200 <= a && 300 > a ? J.put(S, [a, c, kd(d), e]) : J.remove(S));
          ...
          (!c.cache && !a.cache) ||
            ...
            (J = E(c.cache) ? c.cache : E(a.cache) ? a.cache : s);
          J &&
            ((B = J.get(S)),
            x(B)
              ? B && C(B.then)
                ? B.then(H, H)
                : I(B)
                ? n(B[1], B[0], ka(B[2]), B[3])
                : n(B, 200, {}, "OK")
              : J.put(S, M));
          z(B) &&
            ((B = od(c.url)
              ? e()[c.xsrfCookieName || a.xsrfCookieName]
              : void 0) && (T[c.xsrfHeaderName || a.xsrfHeaderName] = B),
            f(
              c.method,
              S,
              d,
        ...
        var s = g("$http");
        a.paramSerializer = D(a.paramSerializer)
            ...
            return R(
              ...
              },
              {
                ...
                $$watchDelegate: function (a, b) {
                  var c;
                  return a.$watchGroup(M, function (d, e) {
                    var f = T(d);
      ...
      function (a, b, d, c, f) {
        function e(e, k, l, m) {
          ...
          v.$$intervalId = H(function () {
            ...
            0 < l &&
              p >= l &&
              (A.resolve(p), u(v.$$intervalId), delete g[v.$$intervalId]);
            K || a.$apply();
          }, k);
          g[v.$$intervalId] = A;
          return v;
  ...
  function Ff() {
    ...
    this.html5Mode = function (a) {
      ...
      if (E(a)) {
        ...
        Ka(a.requireBase) && (b.requireBase = a.requireBase);
            ...
            (u = !1),
              d.$evalAsync(function () {
                ...
                l.absUrl() === b &&
                  (c
                    ? (l.$$parse(a), (l.$$state = e))
                    : (m && h(b, g, e === l.$$state ? null : l.$$state),
                      k(a, e)));
              });
          l.$$replace = !1;
        });
  ...
  function Fd(a) {
    return (
      0 === a.body.length ||
      (1 === a.body.length &&
        (a.body[0].expression.type === t.Literal ||
          a.body[0].expression.type === t.ArrayExpression ||
          a.body[0].expression.type === t.ObjectExpression))
    );
  }
  function Gd(a, b) {
    this.astBuilder = a;
      ...
      function (e) {
        ...
        function k(a, b) {
          return null == a || null == b
            ? a === b
            : "object" === typeof a && ((a = lc(a)), "object" === typeof a)
            ? !1
            : a === b || (a !== a && b !== b);
        }
        ...
        try {
          ...
          C(g)
            ? ((this.promise.$$state.status = -1),
              g.call(a, c, d, f(this, this.notify)))
      ...
      function (e, g, h) {
        ...
        m.prototype = {
          ...
          $watch: function (a, b, d, e) {
            ...
            var h = this,
              k = h.$$watchers,
              l = { fn: b, last: H, get: f, exp: e || a, eq: !!d };
            c = null;
            C(b) || (l.fn = w);
            ...
            return function () {
              var a = bb(k, l);
              0 <= a &&
                (r(h, -1), a < k.$$digestWatchIndex && k.$$digestWatchIndex--);
              c = null;
            };
          },
                    ...
                    try {
                      if ((a = r[r.$$digestWatchIndex]))
                        if (
                          ((m = a.get),
                          (g = m(q)) !== (k = a.last) &&
                            !(a.eq ? na(g, k) : ia(g) && ia(k)))
                        )
                          (p = !0),
                            (c = a),
                            (a.last = a.eq ? sa(g, null) : g),
                            (l = a.fn),
                            l(g, k === H ? g : k, q),
                            5 > s &&
                              ((N = 4 - s),
    ...
    this.$get = [
      ...
      function (a, b) {
        ...
        if (l) {
          ...
          !f ||
            (m && n) ||
            ((m = D(l.webkitTransition)), (n = D(l.webkitAnimation)));
        }
        return {
          history: !(!c || 4 > f || e),
          hasEvent: function (a) {
  ...
  function Na(a, b, d, c, f, e) {
    ...
    switch (g) {
      case "object":
        ...
        if (f) {
          for (k in a)
            if ("$" !== k.charAt(0) && Na(a[k], b, d, c, !0)) return !0;
  ...
  function Nd(a) {
    ...
    return function (a, c, f) {
      ...
      return null == a
        ? a
        : Rd(a, b.PATTERNS[1], b.GROUP_SEP, b.DECIMAL_SEP, f).replace(
            /\u00A4/g,
            c
          );
    };
  ...
  function Pd(a) {
    ...
    return function (a, c) {
      return null == a
        ? a
        : Rd(a, b.PATTERNS[0], b.GROUP_SEP, b.DECIMAL_SEP, c);
    };
  }
  function Og(a) {
    var b = 0,
      ...
      e,
      g;
    -1 < (c = a.indexOf(Sd)) && (a = a.replace(Sd, ""));
    0 < (f = a.search(/e/i))
      ? (0 > c && (c = f), (c += +a.slice(f + 1)), (a = a.substring(0, f)))
      : 0 > c && (c = a.length);
    ...
    function c(a, b) {
      ...
      if (d === k) {
        ...
        "string" === d
          ...
          : "object" === d && (E(k) && (k = a.index), E(l) && (l = b.index));
        k !== l && (c = k < l ? -1 : 1);
      } else c = d < k ? -1 : 1;
      return c;
    }
    ...
    var k,
      l = function (a) {
        ...
        if (!h) {
          var f = b.val();
          a = a && a.type;
          "password" === g || (d.ngTrim && "false" === d.ngTrim) || (f = Y(f));
          (c.$viewValue !== f || ("" === f && c.$$hasNativeValidators)) &&
            c.$setViewValue(f, a);
        }
      };
  ...
  function tc(a, b, d, c) {
    (c.$$hasNativeValidators = E(b[0].validity)) &&
  ...
  function Xd(a) {
    function b(a, b) {
      b && !e[a]
        ? (k.addClass(f, a), (e[a] = !0))
        : !b && e[a] && (k.removeClass(f, a), (e[a] = !1));
    }
    function d(a, c) {
      a = a ? "-" + Hc(a, "-") : "";
      b(rb + a, !0 === c);
    ...
    c.$setValidity = function (a, e, f) {
      ...
      c.$pending
        ? (b(ce, !0), (c.$valid = c.$invalid = void 0), d("", null))
        : (b(ce, !1),
          (c.$valid = be(c.$error)),
          (c.$invalid = !c.$valid),
          d("", c.$valid));
        ...
        if (c !== La && 2 !== c && 8 !== c)
          if (((c = Q(b)), Gb[c]))
            if (x(d))
              ...
              return a[b] || (a.attributes.getNamedItem(b) || w).specified
                ? c
                : void 0;
            ...
            var g = c.length,
              h = function (b, c, g) {
                ...
                h ||
                  ...
                  "$destroy" === b || g || a.addEventListener(b, e, !1));
                h.push(d);
              };
            g--;
  ...
  fb.$$annotate = function (a, b, d) {
    ...
    if ("function" === typeof a) {
      ...
      I(a)
        ? ((b = a.length - 1), Qa(a[b], "fn"), (c = a.slice(0, b)))
        : Qa(a, "fn", !0);
    return c;
  };
  var de = G("$animate"),
  ...
  t.prototype = {
    ...
    primary: function () {
      ...
      this.expect("(")
        ...
        ? (a = sa(this.selfReferential[this.consume().text]))
  ...
  Gd.prototype = {
    compile: function (a, b) {
      ...
      f = new Function(
        ...
        "text",
        f
      )(this.$filter, Ua, Ea, td, wg, Jb, Eg, Bd, a);
  ...
  Hd.prototype = {
    ...
    recurse: function (a, b, d) {
      ...
      switch (a.type) {
        ...
        case t.UnaryExpression:
          return (
            (f = this.recurse(a.argument)), this["unary" + a.operator](f, b)
          );
        case t.BinaryExpression:
          return (
        ...
        case t.Identifier:
          return (
            Ua(a.name, e.expression),
            e.identifier(
              a.name,
              e.expensiveChecks || Lb(a.name),
              b,
              d,
              e.expression
            )
        ...
        case t.MemberExpression:
          return (
            ...
            a.computed ||
              (Ua(a.property.name, e.expression), (f = a.property.name)),
            a.computed && (f = this.recurse(a.property)),
            a.computed
              ? this.computedMember(c, f, b, d, e.expression)
        ...
        case t.ObjectExpression:
          return (
            ...
            function (a, c, d, e) {
              for (var f = {}, r = 0; r < g.length; ++r)
                g[r].computed
                  ? (f[g[r].key(a, c, d, e)] = g[r].value(a, c, d, e))
    ...
    identifier: function (a, b, d, c, f) {
      return function (e, g, h, k) {
        ...
        g = e ? e[a] : void 0;
        b && Ea(g, f);
        return d ? { context: e, name: a, value: g } : g;
      };
    },
      ...
      return {
        ...
        link: function (d, c, f) {
          ...
          "href" === a &&
            ...
            ((g = "xlinkHref"), (f.$attr[g] = "xlink:href"), (e = null));
          f.$observe(b, function (b) {
            b
              ? (f.$set(g, b), Ia && e && c.prop(e, f[g]))
              : "href" === a && f.$set(g, null);
          });
        },
      };
  ...
  var je = {
      ...
      "datetime-local": ob(
        "datetimelocal",
        ge,
        Pb(ge, "yyyy MM dd HH mm ss sss".split(" ")),
      ...
      range: function (a, b, d, c, f, e) {
        ...
        var u = c.$render;
        c.$render =
          m && x(q.rangeUnderflow) && x(q.rangeOverflow)
            ? function () {
                u();
                c.$setViewValue(b.val());
              }
                ...
                e
                  ? (a(e, !0).then(
                      ...
                      function () {
                        c.$$destroyed ||
                          u !== q ||
                          (z(), c.$emit("$includeContentError", e));
                      }
                    ),
        ...
        return {
          ...
          link: function (b, d, c, f) {
            ma.call(d[0]).match(/SVG/)
              ? (d.empty(),
                a(Tc(f.template, y.document).childNodes)(
                  b,
                  function (a) {
                    d.append(a);
                  },
    ...
    gh = [
      ...
      function (a, b, d, c, f, e, g, h, k, l) {
        ...
        this.$$updateEmptyClasses = function (a) {
          p.$isEmpty(a)
            ? (e.removeClass(c, "ng-not-empty"), e.addClass(c, "ng-empty"))
            : (e.removeClass(c, "ng-empty"), e.addClass(c, "ng-not-empty"));
        };
        var y = 0;
        Xd({
          ctrl: this,
        ...
        this.$validate = function () {
          if (!ia(p.$modelValue)) {
            ...
            p.$$runValidators(a, p.$$lastCommittedViewValue, function (e) {
              d ||
                b === e ||
                ((p.$modelValue = e ? a : void 0),
                p.$modelValue !== c && p.$$writeModelToScope());
            });
          }
        };
        ...
        a.$watch(function () {
          ...
          if (
            b !== p.$modelValue &&
            (p.$modelValue === p.$modelValue || b === b)
          ) {
            p.$modelValue = p.$$rawModelValue = b;
            u = void 0;
            for (var c = p.$formatters, d = c.length, e = b; d--; ) e = c[d](e);
            p.$viewValue !== e &&
              (p.$$updateEmptyClasses(e),
              (p.$viewValue = p.$$lastCommittedViewValue = e),
              p.$render(),
              p.$$runValidators(p.$modelValue, p.$viewValue, w));
          }
          return b;
        });
      },
          ...
          function (a, b) {
            ...
            x(this.$options.updateOn)
              ? ((this.$options.updateOnDefault = !1),
                (this.$options.updateOn = Y(
                  this.$options.updateOn.replace(hh, function () {
              ...
              function n() {
                ...
                if (w)
                  for (var b = w.items.length - 1; 0 <= b; b--) {
                    var c = w.items[b];
                    x(c.group) ? Fb(c.element.parentNode) : Fb(c.element);
                  }
                w = C.getOptions();
                var d = {};
                A && h.prepend(u);
                ...
                : ((r.writeValue = function (a) {
                    ...
                    c
                      ...
                      ? (y.remove(),
                        A || h.prepend(u),
                        h.val(""),
                        v && (u.prop("selected", !0), u.attr("selected", !0)))
                      : (E(),
                        h.prepend(y),
                        h.val("?"),
                        y.prop("selected", !0),
                  ...
                  (r.readValue = function () {
                    ...
                    return a && !a.disabled
                      ? (E(), y.remove(), w.getViewValueFromOption(a))
                      : null;
                  }),
                  C.trackBy &&
                    d.$watch(
          ...
          compile: function (e, g) {
            ...
            return function (a, d, e, g, l) {
              ...
              a.$watchCollection(n, function (e) {
                ...
                for (g = 0; g < z; g++)
                  if (
                    ((y = e === F ? g : F[g]), (C = e[y]), (E = G[g]), E.scope)
                  ) {
                    s = p;
                    do s = s.nextSibling;
        ...
        return {
          ...
          compile: function (b, d) {
            ...
            x(d.ngValue)
              ...
              : x(d.value)
              ? (c = a(d.value, !0))
              : (f = a(b.text(), !0)) || d.$set("value", b.text());
            return function (a, b, d) {
              var k = b.parent();
              (k =
  ...
  y.angular.bootstrap
    ? y.console && console.log("WARNING: Tried to load angular more than once.")
    : (xe(),
      ze($),
      $.module(
        "ngLocale",
